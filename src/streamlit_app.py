...
# Add a defensive UX warning to inform users about the limitations of the application
st.warning("WARNING! 🚨 Our AI might make mistakes or hallucinate results. Always double-check the output before trusting it for anything important!")
